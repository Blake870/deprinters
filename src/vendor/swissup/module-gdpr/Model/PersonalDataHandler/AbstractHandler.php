...
class AbstractHandler
{
     ...
     * @return boolean
     */
    protected function useWebsiteFilter()
    {
     ...
     * @return array
     */
    protected function getStoreIds(ClientRequest $request)
    {
     ...
     * @return void
     */
    protected function anonymizeCollections($collections, $data, $useDbQuery = false)
    {
