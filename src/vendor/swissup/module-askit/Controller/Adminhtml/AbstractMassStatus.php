...
class AbstractMassStatus extends \Magento\Backend\App\Action
{
     ...
     * @var string
     */
    protected $collectionClass = \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection::class;
     ...
     * @var string
     */
    protected $modelClass = \Magento\Framework\Model\AbstractModel::class;
