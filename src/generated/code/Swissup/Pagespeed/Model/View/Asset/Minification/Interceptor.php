<?php
namespace Swissup\Pagespeed\Model\View\Asset\Minification;

/**
 * Interceptor class for @see \Swissup\Pagespeed\Model\View\Asset\Minification
 */
class Interceptor extends \Swissup\Pagespeed\Model\View\Asset\Minification implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\App\State $appState, \Swissup\Pagespeed\Helper\Config $configHelper, $scope = 'store')
    {
        $this->___init();
        parent::__construct($scopeConfig, $appState, $configHelper, $scope);
    }
